We can create a new variable to store the result, and just add to it the right most (or least significant) bit of the binary representation of n, then we right shift n to 
``` python
class Solution:
